...
const TicTacToe = () => {
    ...
    const reset=()=>{
        setLock(false);
        data=["","","","","","","","",""];
        titleRef.current.innerHTML='Tic Tac Toe game by <span>Kaarthik Rajeev</span>'
  ...
  return (
    <div className='container'><h1 className="title" ref={titleRef}>Tic Tac Toe game by <span>Kaarthik Rajeev</span></h1>
    <div className="board">
        <div className="row1">
